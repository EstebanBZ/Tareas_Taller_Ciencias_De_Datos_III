...
% CONTACT INFORMATION
%====================
\def\name{Esteban Barrios} % Name Here
\def\phone{(+56) 9 7464 4726}
\def\city{Santiago, Chile}
\def\email{esteban.barrios@mayor.cl}
\def\LinkedIn{esteban-barrios-0178b4152} % linkedin.com/in/______
\def\github{EstebanBZ} % github username
\def\role{Junior Data Scientist} % JOB TITLE
